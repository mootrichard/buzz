...
|---|---|---|---|
| `30182` | owner | parameterized replaceable | runner registration or revocation |
...
3. an owner-signed active kind `30182` registration.
...
```text
30182:<owner-pubkey>:<runner-pubkey>
```
