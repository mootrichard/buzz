...
///
/// Kind 30182 replaces the fork's original 30178 assignment, which now belongs
/// to the upstream NIP-AP team-catalog projection.
pub const KIND_RUNNER_REGISTRATION: u32 = 30182;
